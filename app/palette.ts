...
const inventoryExtras: Entry[] = [
  ["11455", "Technic Link 2 x 4 Bent 90", 11], ["11955", "Technic Gear 8 Tooth Reinforced Sliding", 5],
  ...
  ["37308c01", "Powered Up Colour Sensor", 11], ["37312c01", "Powered Up Force Sensor", 11],
  ...
  ["5405", "Technic Gear 4 Knob 45°", 86],
  ["54675c01", "Powered Up Large Angular Motor", 156], ["55981", "Wheel Rim 14 x 18 Holes", 86],
...
const modelAlias:Record<string,string>={"4265c":"32123b","4185":"4185b","6538c":"59443","3648":"3648b","44":"32126","18938u":"18938","62520c01":"62520","6628a":"6628"};
export const paletteRequestAliases:Record<string,string>={"32123a":"4265c","32556b":"32556"};
const thumbAlias:Record<string,string>={"32556":"32556b","19467c01":"19467","21828c01":"21828","37308c01":"37308","37312c01":"37312","54675c01":"54675","5405":"195405s01","3167":"3167s01","2477":"24779s01"};
const thumbId:Record<string,number>={
  ...
  "11455":50663,"11955":493,"13971":628,"15038":746,"18938":1292,"18939":1293,"18940":1294,"18942":1295,
  "19467c01":1515,"21828c01":1784,"2391":24189,"2393":24191,"24121":2231,"2477":17101,"27938":3111,"2815":49713,"3167":33532,
  "32009":5499,"32019":5507,"32072":5552,"32185":5615,"32209":5643,"32249":5664,"32348":5734,"32905":5842,"37308c01":6793,"37312c01":6796,
  "3743":6824,"39369":7361,"39790":7470,"39794":7472,"44":5582,"46834":25212,"46835":9356,"4697b":9374,"49283":9796,"50945":25293,
  "5405":16862,"54675c01":10114,"55981":10219,"55982":10222,"56145":10228,"56903":10266,"56908":10271,"61408":46051,"64781":11700,
...
export const paletteParts=Object.entries(groups).flatMap(([family,entries])=>entries.map(([part,name,bricklinkColor])=>{const modelPart=modelAlias[part]??part,id=thumbId[modelPart],thumbPart=thumbAlias[part]??modelPart,sourceColor=ldrawColor[bricklinkColor]??71,color=defaultColorOverride[part]??sourceColor;return{
  part,name,family:family as PaletteFamily,color,sourceColor,kind:(family==="gears"||family==="wheels"||family==="specials"?"wheel":family==="spike"&&/motor/i.test(name)?"motor":"beam") as "beam"|"wheel"|"motor",gear:family==="gears",modelPart,rawThumb:true,
